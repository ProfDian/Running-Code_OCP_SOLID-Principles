...
print("=== ABDUL FATTAH RAHMADAINSYAH - 21120122120028 ===")
print("==== MATA KULIAH METODE NUMERIK KELAS B ====")

# Menu pilihan
print("Silahkan Pilih Metode:")
print("1. Metode Matriks Balikan")
print("2. Metode LU Decomposition")
print("3. Metode Crout")
print("4. Keluar")

# Mulai loop untuk meminta pilihan pengguna
while True:
    # Meminta pilihan pengguna
    choice = input("Masukkan nomor metode yang ingin Anda gunakan atau ketik '4' untuk keluar: ")

    if choice == '4':
        print("Terima kasih telah menggunakan program. Sampai jumpa!")
        break  # Keluar dari loop
    elif choice in ['1', '2', '3']:
        choice = int(choice)  # Konversi ke integer
        ...
        print("Pilihan tidak valid. Silahakn pilih ya!")
